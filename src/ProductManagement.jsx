        ...
        <Card className="shadow-lg mb-4">
          <Card.Body className="p-4">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <div>
                <h5 className="fw-semibold mb-1">Add New Product</h5>
              ...
              <Card className="mb-4 border-0 shadow-sm">
                ...
                <Card.Body>
                  <Row>
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        <Form.Label className="fw-semibold">Display Title (Auto-filled)</Form.Label>
                        <Form.Control
                          type="text"
                          value={newProduct.title}
                          readOnly
                          className="bg-light"
                          placeholder="Will be auto-filled with subcategory name"
                        />
                        <small className="text-muted">This will appear as the main heading in frontend (auto-set to subcategory name)</small>
                      </Form.Group>
                    </Col>
                  </Row>
              ...
              <Card className="mb-4 border-0 shadow-sm">
                ...
                <Card.Body>
                  <Row>
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        <Form.Label className="fw-semibold">Subcategory (Main Heading) *</Form.Label>
                        <Form.Select
                        ...
                        <small className="text-muted">This will be the main heading/title shown in frontend</small>
                      </Form.Group>
                    </Col>
                  </Row>
            ...
            <Table hover responsive>
              <thead>
                <tr>
                  ...
                  <th>Product Name</th>
                  <th>Category</th>
                  <th>Subcategory (Frontend Title)</th>
                  ...
                  products
                    ...
                    .map((product) => (
                      <tr key={product._id}>
                        ...
                        <td>
                          <div>
                            <strong className="d-block">{product.title || product.subcategory || '-'}</strong>
                            <small className="text-muted">Will appear as main heading in frontend</small>
                          </div>
                        </td>
                        <td>
                          <div>
                            <strong className="d-block">₹{product.price}</strong>
